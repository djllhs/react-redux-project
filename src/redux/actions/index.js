...
import {
  ...
  DOCUMENT_OPERATION_LIST,
  BANNER_MANAGEMENT_LIST,
  BANNER_MANAGEMENT_LOCATIONS,
  BANNER_MANAGEMENT_ACTIONS,
  PUSH_MANAGEMENT_LIST,
  PUSH_MANAGEMENT_ADD,
  PUSH_MANAGEMENT_MODIFY,
  PUSH_MANAGEMENT_STOP,
  PUSH_MANAGEMENT_DELETE,
  PUSH_MANAGEMENT_TEST,
  PUSH_MANAGEMENT_PUSH,
  CLICK_READ_BOOK_LIST,
  CLICK_READ_BOOK_CATALOG_LIST,
  CLICK_READ_BOOK_PAGE_LIST,
  CLICK_READ_BOOK_TRACK_LIST,
  GET_SOME_RESOURCE,
  COUPON_BATCH_LIST,
  COUPON_LIST
} from '../../api';
...
// 数据维护 文案操作列表
export const documentOperationList = (param = {}) => {
  param = Object.assign({}, defaultListParams, param);
  return {
    type: types.DOCUMENT_OPERATION_LIST,
    payload: {
      promise: getData(`${DOCUMENT_OPERATION_LIST}`, param),
      requestParams: param
    }
  };
};
